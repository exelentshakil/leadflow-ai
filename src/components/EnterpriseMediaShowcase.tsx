...
export function EnterpriseMediaShowcase() {
  ...
  const architecturalPillars = [
    {
      id: 'pillar-webhook',
      tag: 'n8n / Make Webhook Intake',
      title: 'Sub-Second Inbound Lead Normalization',
      description: 'Ingest webhooks from Webflow, WordPress, or custom forms with strict schema validation, rate-limiting, and duplicate lead deduplication.',
    },
    {
      id: 'pillar-llm',
      tag: 'Claude 3.5 & GPT-4o-mini',
      title: 'Structured JSON Qualification & Reply Synthesis',
      description: 'Extract prospect intent, evaluate commercial urgency (0–100 score), and draft a personalized, contextual reply ready for human approval.',
    },
    {
      id: 'pillar-crm',
      tag: 'CRM & Slack Gateway',
      title: 'Dual-Store Sync & 1-Click Approval Cards',
      description: 'Sync structured lead data to Google Sheets, Airtable, or HubSpot while alerting your team in Slack with interactive 1-click approval buttons.',
    },
  ];
          ...
          <div className="relative z-10 w-full p-6 sm:p-10 flex flex-col justify-between gap-8">
            ...
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center gap-2 rounded-full bg-black/75 backdrop-blur-md px-3.5 py-1.5 text-xs font-mono text-white border border-white/20 shadow-lg">
                ...
                <span className="font-semibold tracking-wide" style={{ color: '#ffffff' }}>Live Automation Engine</span>
                <span className="text-white/40">|</span>
                <span className="text-slate-300" style={{ color: '#CBD5E1' }}>Pipeline Node #904</span>
              </div>
            ...
            <div className="max-w-2xl rounded-xl bg-black/85 backdrop-blur-md border border-white/20 p-6 sm:p-7 shadow-2xl space-y-3">
              ...
              >
                Building production automation infrastructure for {siteConfig.name}.
              </h2>
              <p
                style={{ color: '#E2E8F0' }}
        ...
        <div>
          ...
          <div className="max-w-3xl mb-8 sm:mb-10">
            <div className="text-xs font-mono uppercase tracking-wider text-[#533AFD] dark:text-[#7A68FF] font-semibold mb-1">
              Field-Tested Workflow Architecture
            </div>
            <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-[var(--color-text-primary)]">
              Automating inbound operations of all sizes.{' '}
              <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
                Built to adapt seamlessly from rapid website forms to 10,000+ monthly enterprise leads.
              </span>
            </h3>
          </div>
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-2xs hover:shadow-xs transition-shadow mb-8">
            <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-900">
              ...
              <img
                ...
                alt="Production workflow automation interface"
            ...
            <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="space-y-1 max-w-2xl">
                <div className="text-base sm:text-lg font-bold text-[var(--color-text-primary)]">
                  Inbound Sales Pipeline Automation
                </div>
                <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] opacity-85 leading-relaxed">
                  Eliminated manual lead triage bottlenecks through automated Claude 3.5 qualification, instant CRM synchronization, and interactive Slack approval cards.
                </p>
              </div>
              ...
              <div className="flex items-center gap-6 text-xs font-mono text-[var(--color-text-secondary)] shrink-0">
                ...
                <div>
                  <div className="text-lg font-bold text-[#533AFD] dark:text-[#7A68FF]">&lt;45s</div>
                  <div className="text-[10px] opacity-75">Response Velocity</div>
                </div>
              </div>
            </div>
          </div>
