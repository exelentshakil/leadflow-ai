...
const FEATURES: FeatureItem[] = [
  {
    id: 'services',
    icon: LayoutGrid,
    title: 'Workflow architecture (n8n vs Make).',
    description: 'We recommend n8n for self-hosted credential ownership, zero per-step operational fees, and advanced error branching, or Make for rapid cloud setup without hosting overhead.',
    linkText: 'View workflow & live engine',
    action: 'pipeline',
  },
  {
    id: 'certifications',
    icon: Users,
    title: 'Securiti-certified AI governance.',
    description: 'Work with a validated AI security architect specializing in Gartner AI TRiSM, NIST AI RMF, and inline LLM firewalls that sanitize prompt injections and redact prospect PII (Cert ID: 14B411BCE-14B411A3D-1451CFE76).',
  ...
  },
  {
    id: 'retainers',
    icon: MessageSquare,
    title: 'Error alerts & 7-day warranty.',
    description: 'Includes dead-letter failure recovery, automatic Slack/Email alert webhooks, a short Loom walkthrough, 1-page SOP documentation, and 7 days of post-delivery bug-fix support.',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[var(--color-text-primary)]">
            Production reliability for your business.{' '}
            <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
              Every workflow runs in your own accounts with full credential ownership and zero vendor lock-in.
            </span>
          </h2>
        </div>
